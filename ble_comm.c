...
#define DEVICE_NAME                         "Gait_Sensor"                            /**< Name of device. Will be included in the advertising data. */
...
static ble_uuid_t m_adv_uuids[] =                                   /**< Universally unique service identifiers. */
{
    ...
    {BLE_UUID_IMU_SERVICE_UUID,             BLE_UUID_TYPE_BLE},
    {BLE_UUID_ACCEL_CHARACTERISTC_UUID,     BLE_UUID_TYPE_BLE}
};

static ble_imu_t m_imu;
 ...
 */
void ble_comm_timers_start(void)
{
    ret_code_t err_code;
